...
class Question(models.Model):
    """An exam question attached to a lesson in a course."""
    ...
    def is_get_score(self, selected_ids):
        """Return True only when the learner selected every correct choice."""
        correct_ids = set(
...
class Submission(models.Model):
    """A learner's selected choices for one exam attempt."""
